...
class JobViewList(APIView):
    ...
    def post(self, request):
        ...
        if serializer.is_valid():
            ...
            command = str(["/bin/bash","-i", "-c", "/home/ubuntu/pig-0.15.0/bin/pig", "-x","local", "-param user_input=\"/home/ubuntu/WebAppStupidServer/"+str(job.id)+".txt\"","-param output_path=/home/ubuntu/output/"+str(job.id) ,"/home/ubuntu/sentence_search.pig"])
            file.close()
